...
function i(e){e.state?.replaced||(r=!0,setTimeout(()=>r=!1))}o&&e?.beforeEach&&(t.nextTick(()=>{window.addEventListener("popstate",i),l=e.beforeEach((e,t,l)=>{kn?r?a(l):l():setTimeout(()=>r?a(l):l()),kn=!0}),n=e?.afterEach(()=>{kn=!1})}),t.onScopeDispose(()=>{window.removeEventListener("popstate",i),l?.(),n?.()}))}(O,t=>{V.value&&v.value?(t(!1),e.persistent?H():v.value=!1):t()})})
const j=t.ref()
...
r.value?.$el.contains(t)||(A.value=!1)}function U(){if(e.eager&&c.value?.calculateVisibleItems(),F.value){const t=function(){if(!h.value.length)return-1
...
F.value.focus(t>=0?t:"first")}}function G(){m.value="",k.value&&r.value?.focus()}function K(e){k.value=!0}function q(e){if(null==e)h.value=[]
...
t&&ie(t)}}function Z(){e.eager&&d.value?.calculateVisibleItems()}function Q(){i.value&&(s.value=!0,r.value?.focus()),p.value=null}function J(e){i.value=!0,setTimeout(()=>{u.value=!0})}function ee(e){u.value=!1}function te(t){null!=t&&(""!==t||e.multiple||_.value)||(w.value=[])}function ae(e){const t=c.value?.contentEl
...
return t.split(new RegExp(`(?:${a})+`))}async function ie(a){for(let l of a)l=l.trim(),l&&(le(Tr(e,l)),await t.nextTick())}function se(e){s.value=!0,setTimeout(()=>{c.value=!0})}function ce(e){c.value=!1}function ve(e){const t=d.value?.contentEl
...
a(c)&&n.preventDefault()}}function N(e){l("update:period",e)
const a=s("hour","am"===e?23:11,!0)
t.nextTick(()=>g.value=vg(a))}const C=t.ref(),E=t.ref(),I=t.ref()
...
if(a&&e in a)return a[e]}Ug.version="3.12.2"
const Kg=function(){return Ug({components:Fg,directives:Wg,...arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}})},qg="3.12.2"
