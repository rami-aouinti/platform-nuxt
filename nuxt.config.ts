  ...
  vite: {
    resolve: {
      alias: [
        ...
        { find: 'jsvectormap/dist/maps/world.js', replacement: './app/shims/jsvectormap-world.ts' },
        { find: 'jsvectormap/dist/maps/world-merc', replacement: './app/shims/jsvectormap-world-merc.ts' },
        { find: 'jsvectormap/dist/css/jsvectormap.min.css', replacement: './app/shims/jsvectormap.min.css' },
        { find: /^jsvectormap\//, replacement: './app/shims/jsvectormap/' },
        { find: /^leaflet$/, replacement: './app/shims/leaflet/index.ts' },
        { find: 'leaflet/dist/leaflet.css', replacement: './app/shims/leaflet.css' },
        ...
        { find: 'quill/dist/quill.snow.css', replacement: './app/shims/quill.snow.css' },
